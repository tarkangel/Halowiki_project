...
const UI = {
  en: { title: 'Races',  sub: 'Sentient species of the Halo universe' },
  es: { title: 'Razas',  sub: 'Especies del universo Halo' },
};

export default function Races() {
  const { lang } = useLanguage();
  const { data, loading, error } = useFetch(() => fetchRaces(lang), [lang]);
  const t = UI[lang];
  return (
    <div>
