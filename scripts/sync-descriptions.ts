...
const CURATED: Record<string, string> = {
  ...
  'Guilty Spark':
    "343 Guilty Spark is a Forerunner Monitor — an AI construct tasked with maintaining Installation 04. Driven to obsession after a hundred thousand years of isolation, he manipulated the Master Chief into helping him contain a Flood outbreak. When the Master Chief refused to fire Installation 04, Guilty Spark became increasingly erratic, turning violently against his allies before being destroyed — only to resurface in altered form.",
  'Dadab':
